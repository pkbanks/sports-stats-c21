...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post stats_url, params: { stat: { player_id: @stat.player_id, type: @stat.type, value: @stat.value } }
    end
  ...
  test "should update stat" do
    patch stat_url(@stat), params: { stat: { player_id: @stat.player_id, type: @stat.type, value: @stat.value } }
